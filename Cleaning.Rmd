...
spread_mod1 = lm(formula = Spread ~ FG_PCT_home + FT_PCT_home + AST_home + 
    REB_home + FG_PCT_away + FT_PCT_away + AST_away + 
    OREB_away + DREB_home + DREB_away + OREBP_home + OREBP_away + 
    EFGP_home + EFGP_away + TOVP_home + TOVP_away + FTR_home + 
    FTR_away + AVG_HEIGHT_away + AVG_WEIGHT_away + WEIGHT_PROP_diff, 
    data = GAMES_spread)
summary(spread_mod1)
...
spread_cor %>% 
  focus(FG_PCT_home, FT_PCT_home, AST_home,
    REB_home, FG_PCT_away, FT_PCT_away, AST_away,
    OREB_away,DREB_home, DREB_away, OREBP_home, OREBP_away, 
    EFGP_home, EFGP_away, TOVP_home, TOVP_away, FTR_home, 
    FTR_away, AVG_HEIGHT_away, AVG_WEIGHT_away, WEIGHT_PROP_diff, 
    data = GAMES_spread, mirror=TRUE)
```
```{r}
#Add interaction terms of high correlation variables
spread_mod2 = lm(formula = Spread ~ FG_PCT_home + FT_PCT_home + AST_home + 
    REB_home + FG_PCT_away + FT_PCT_away + AST_away + 
    OREB_away + DREB_home + DREB_away + OREBP_home + OREBP_away + 
    EFGP_home + EFGP_away + TOVP_home + TOVP_away + FTR_home + 
    FTR_away + AVG_HEIGHT_away + AVG_WEIGHT_away + WEIGHT_PROP_diff +(OREBP_away*OREB_away)+(FG_PCT_away*EFGP_away) +(FG_PCT_home*EFGP_home), 
    data = GAMES_spread)
summary(spread_mod2)
plot(spread_mod2)
```
...
```
```{r}
best_total <- lm(formula = log(Total) ~ FG_PCT_home + FT_PCT_home + AST_home + 
    FG_PCT_away + FT_PCT_away + FG3_PCT_away + AST_away + REB_away + 
    OREB_home + DREB_home + OREBP_home + OREBP_away + EFGP_home + 
    EFGP_away + TOVP_home + TOVP_away + FTR_home + FTR_away + 
    HEIGHT_PROP_away + AVG_HEIGHT_home + AVG_HEIGHT_away + AVG_WEIGHT_home + WEIGHT_PROP_diff, data = GAMES_total)
summary(best_total)
```
```{r}
best_total2 <- lm(formula = log(Total) ~ FG_PCT_home + FT_PCT_home + AST_home + 
...
total_cor %>% 
  focus(FG_PCT_home,FT_PCT_home,AST_home,
    ...
    OREB_home, DREB_home, OREBP_home,OREBP_away, EFGP_home, 
    EFGP_away, TOVP_home, TOVP_away, FTR_home, FTR_away, 
    HEIGHT_PROP_away, AVG_HEIGHT_home,AVG_HEIGHT_away, AVG_WEIGHT_home, WEIGHT_PROP_diff, mirror=TRUE)
```
```{r}
best_total3 <- lm(formula = log(Total) ~ FG_PCT_home + FT_PCT_home + AST_home + 
    FG_PCT_away + FT_PCT_away + AST_away + REB_away + 
    OREB_home + DREB_home + OREBP_home + OREBP_away + EFGP_home + 
    EFGP_away + TOVP_home + TOVP_away + FTR_home + FTR_away + 
    HEIGHT_PROP_away + AVG_HEIGHT_home + AVG_HEIGHT_away + AVG_WEIGHT_home + WEIGHT_PROP_diff +(OREBP_home*OREB_home)+(FG_PCT_away*EFGP_away) +(FG_PCT_home*EFGP_home), data = GAMES_total)
summary(best_total3)
